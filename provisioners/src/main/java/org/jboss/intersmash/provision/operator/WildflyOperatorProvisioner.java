 ...
 */
<<<<<<<< HEAD:provisioners/src/main/java/org/jboss/intersmash/provision/openshift/WildflyOperatorProvisioner.java
package org.jboss.intersmash.provision.openshift;
========
package org.jboss.intersmash.tools.provision.operator;
>>>>>>>> a372bbb ([k8s-support] - Complete draft of k8s provisioning tooling, with Hyperfoil test enabled. Missing parts: docs (limitations and operators based + prerequisited), CI):tools/intersmash-tools-provisioners/src/main/java/org/jboss/intersmash/tools/provision/operator/WildflyOperatorProvisioner.java
