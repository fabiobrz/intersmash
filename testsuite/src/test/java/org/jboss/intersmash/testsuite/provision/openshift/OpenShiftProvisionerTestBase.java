...
import org.jboss.intersmash.tools.util.wildfly.WildflyJavaxCliScriptBuilder;
...
public class OpenShiftProvisionerTestBase {
	...
	static final String WILDFLY_JAKARTA_EE8_TEST_REPO = "https://github.com/openshift/openshift-jee-sample.git";
	static final String WILDFLY_JAKARTA_EE8_TEST_REF = "master";
	...
	static WildflyJavaxImageOpenShiftApplication getWilflyJavaxOpenShiftImageApplication() {
		return new WildflyJavaxImageOpenShiftApplication() {

			@Override
			public List<String> getCliScript() {
				WildflyJavaxCliScriptBuilder cliScriptBuilder = new WildflyJavaxCliScriptBuilder();
			...
			@Override
			public BuildInput getBuildInput() {
				return new BuildInputBuilder().uri(WILDFLY_JAKARTA_EE8_TEST_REPO).ref(WILDFLY_JAKARTA_EE8_TEST_REF).build();
			}
