...
import org.jboss.intersmash.provision.openshift.operator.hyperfoil.client.runschema.RunStatisticsWrapper;
import org.jboss.intersmash.provision.openshift.operator.hyperfoil.client.v05.HyperfoilApi;
import org.jboss.intersmash.provision.openshift.operator.hyperfoil.client.v05.invoker.ApiClient;
import org.jboss.intersmash.provision.openshift.operator.hyperfoil.client.v05.invoker.ApiException;
import org.jboss.intersmash.provision.openshift.operator.hyperfoil.client.v05.invoker.Configuration;
...
<<<<<<<< HEAD:testsuite/integration-tests/src/test/java/org/jboss/intersmash/testsuite/provision/openshift/HyperfoilOperatorProvisionerTest.java
========
...
>>>>>>>> a372bbb ([k8s-support] - Complete draft of k8s provisioning tooling, with Hyperfoil test enabled. Missing parts: docs (limitations and operators based + prerequisited), CI):testsuite/integration-tests/src/test/java/org/jboss/intersmash/testsuite/provision/openshift/HyperfoilOpenShiftOperatorProvisionerTest.java
...
public class HyperfoilOpenShiftOperatorProvisionerTest implements ProjectCreationCapable {
	...
	private static final HyperfoilOpenShiftOperatorProvisioner hyperfoilOperatorProvisioner = initializeOperatorProvisioner();

	private static HyperfoilOpenShiftOperatorProvisioner initializeOperatorProvisioner() {
		HyperfoilOpenShiftOperatorProvisioner operatorProvisioner = new HyperfoilOpenShiftOperatorProvisioner(
